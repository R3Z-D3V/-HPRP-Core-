...
exports['wasabi_banking']:GetAccountBalance(society, 'society')
end

function CRUX.RegisterSociety(name, label, account, datastore, inventory, data)
   exports['wasabi_banking']:CreateJobAccount(name, 0)
end

function CRUX.AddSocietyMoney(society, amount, reason)
    return exports['wasabi_banking']:AddMoney('society', society, amount)
end

function CRUX.RemoveSocietyMoney(society, amount, reason)
    return exports['wasabi_banking']:RemoveMoney('society', society, amount)
end
...
function CRUX.AddTransaction(receiver_name, receiver_identifier, sender_name, sender_identifier, value, reason, targetId)
    ...
    return exports.wasabi_banking:Transaction(sender_identifier, reason, value, "withdrawal", "personal")
end

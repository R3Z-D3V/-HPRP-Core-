...
local function SetupVehicleMenu()
    ...
    if Vehicle ~= 0 then
        ...
        -- Config.VehicleControl'den item ekle
        if Config.VehicleControl then
            for _, control in pairs(Config.VehicleControl) do
                VehicleMenu.items[#VehicleMenu.items + 1] = control
            end
        end
    end

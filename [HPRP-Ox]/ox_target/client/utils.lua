...
SetTimeout(0, function()
    setmetatable(playerItems, {
        __index = function(self, index)
            -- FINAL FIX APPLIED: Using the correct resource name 'ox_inventory' and its standard export 'GetItemCount'.
            local count = exports["ox_inventory"]:GetItemCount(index) or 0
            local value = count >= 1 and 1 or 0
            return value
        end
    })

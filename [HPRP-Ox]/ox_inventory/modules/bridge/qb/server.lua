...
function server.getAccountMoney(playerId, account)
	...
	if xPlayer then
		...
		local acc = xPlayer.PlayerData.money[account]
...
exportHandler('AddItem', function(playerId, itemName, itemCount, slot, metadata)
	Inventory.AddItem(playerId, itemName, itemCount, slot, metadata)
end)
exportHandler('RemoveItem', function(playerId, itemName, itemCount, slot, metadata)
	Inventory.RemoveItem(playerId, itemName, itemCount, slot, metadata)
end)
